...
$(window).load(function() {
    ...
    nav.on('sticky-start', function() {
        logo.attr('fill', 'url(#logo-background)');
    });
       ...
       //contact form submit handler
        onSubmit: function (evt) {
            ...
            $.ajax({
                ...
                success: function() {
                    self.alert.html("<strong>Yay!</strong> You're email has been sent. I'll be in touch shortly.");
                    self.alert.addClass('alert-success').removeClass('hidden');
                }
            });
        },
        hideAlert: function() {
            this.alert.removeClass('alert-danger alert-success').addClass('hidden');
        },
        init: function () {
            //initializing the contact form
            this.form.on('submit', this.onSubmit.bind(this));
            this.form.on('focusin', this.hideAlert.bind(this));
            return this;
        }
    };
